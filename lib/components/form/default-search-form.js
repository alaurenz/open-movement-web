  ...
  render () {
    ...
    return (
      <div>
        ...
        <div className='error-message orange-message'><strong>Under active development: </strong><br /> This demo only has partial support on mobile and current location not yet supported.</div>
      </div>
    )
  }
}
